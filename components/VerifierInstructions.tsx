    ...
    <div className="px-4 my-4 col-lg-10">
      ...
      <ol className={styles['steps']}>
        ...
        <li>
          ...
          More</strong><br />
          <Image src="/images/inst_history_view_more.png" className="img-fluid" alt="History screenshot" width="850" height="272" />
        </li>
        <li>
          Click <strong>Load More</strong> at the bottom of the All Transactions panel.<br />
          <Image src="/images/inst_load_more.png" className="img-fluid" alt="Load More screenshot" width="850" height="250" />
        </li>
        <li>
        ...
        <li>
          ...
          <Image src="/images/inst_v_symbol.png" className="img-fluid" alt="V Symbol screenshot" width="850" height="65" />
        </li>
